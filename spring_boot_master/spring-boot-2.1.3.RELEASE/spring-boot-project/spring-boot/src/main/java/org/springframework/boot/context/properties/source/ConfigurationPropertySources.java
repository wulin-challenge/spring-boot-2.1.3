...
public final class ConfigurationPropertySources {
	 ...
	 * 
	 * <p> 附加一个 {@link ConfigurationPropertySource} 以支持指定的环境,通过环境管理每一个 {@link PropertySource} 以适应一个
	 * {@link ConfigurationPropertySource},并且允许使用配置属性名称解析金典的{@link PropertySourcesPropertyResolver}调用
	 * 
	 * <p> The attached resolver will dynamically track any additions or removals from the
	 * underlying {@link Environment} property sources.
	 * 
	 * <p> 这附加的解析将动态跟踪任何从这个潜在的环境属性源中的添加和删除
	 * 
	 * @param environment the source environment (must be an instance of
	 * {@link ConfigurableEnvironment})
	 * 
	 * <p> 源环境(必须属于{@link ConfigurableEnvironment} 的一个实例 )
	 * 
	 * @see #get(Environment)
	 */
